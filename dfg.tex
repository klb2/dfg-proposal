...
%		 Karl-Ludwig Besser, k.besser@tu-bs.de
%
%Date: 03/07/2021

\usepackage{blindtext}
\usepackage[utf8]{inputenc}
\usepackage[firsttime]{proposal}
...
Prof. Name Author\\
University 1, Institute/Group Name (Abbr1)

Author 2\\
University 2, Institute/Group Name (Abbr2)

\textbf{Long Title of the Project Proposal}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\GetTranslation{starting-point}}
\label{sec:work-report}

\subsection{\GetTranslation{preliminary-work}}
...
We apply for a total of \SI{10000}{\sieuro} for travel expenses.
